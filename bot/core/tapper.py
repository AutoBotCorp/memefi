    ...
    async def join_clan(self, http_client):
        try:
            json_data = {
                ...
                'query': Query.Join,
                'variables': {'clanId': 'df638a2c-ede9-4dfa-a35f-ea50f2816a6b'}
            }
        ...
        while True:
            ...
            try:
                ...
                if first_check_clan():
                    ...
                    if clan is not False and clan != 'df638a2c-ede9-4dfa-a35f-ea50f2816a6b':
                        await asyncio.sleep(1)
                        ...
                        if clan_leave is True:
                            ...
                            continue
                    elif clan == 'df638a2c-ede9-4dfa-a35f-ea50f2816a6b':
                ...
                if telegramMe['isReferralInitialJoinBonusAvailable'] is True:
                    ...
                    logger.success(f"{self.session_name} | 🔥Referral bonus was claimed")
                ...
                if bot_config['isPurchased'] is True:
                    if bot_config['usedAttempts'] < bot_config['totalAttempts'] and not bot_config['endsAt']:
                        ...
                        if tapbotClaim['isClaimed'] == False and tapbotClaim['data']:
                            logger.info(f"{self.session_name} | 👉 Tapbot was claimed - 😴 Sleep 7s before starting again")
                            await asyncio.sleep(delay=7)
            ...
            #        logger.error(f"{self.session_name} | Warning! Invalid protocol detected in {error}")
                ...
                logger.info(f"{self.session_name} | 😴 Wait 5m")
                await asyncio.sleep(delay=300)
                ...
                if active_turbo is True:
                    sleep_between_clicks = 5
                elif noBalance is True:
                    sleep_between_clicks = 500
